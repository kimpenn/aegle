#!/bin/bash
# =============================================================================
# Datasink Launcher for Fallopian Tube (FT) Cohort
# =============================================================================
# Collects HTML reports from main and analysis pipelines and uploads to Box.
#
# Usage:
#   ./launcher/run_datasink_ft.sh [--dry_run] [--no_upload]
#
# Options:
...
echo "============================================================"
echo "Aegle Datasink - Fallopian Tube (FT) Cohort"
echo "============================================================"
...
echo ""
echo "[1/2] Collecting main pipeline reports (main_ft_hb)..."
echo "------------------------------------------------------------"
...
echo ""
echo "[2/2] Collecting analysis pipeline reports (analysis_ft_hb)..."
echo "------------------------------------------------------------"
python src/datasink.py \
    --stage analysis \
    --exp_set analysis_ft_hb \
    --out_root "${OUT_ROOT}" \
    --remote "${REMOTE}" \
    --remote_path "${REMOTE_PATH}" \
    ${UPLOAD} \
...
echo ""
echo "============================================================"
echo "Datasink completed for FT cohort!"
echo "============================================================"
