#!/bin/bash
# =============================================================================
# Datasink Launcher for Uterus Cohort
# =============================================================================
# Collects HTML reports from main and analysis pipelines and uploads to Box.
#
# Usage:
#   ./launcher/run_datasink_uterus.sh [--dry_run] [--no_upload]
#
# Options:
...
#
# =============================================================================
# bash /workspaces/codex-analysis/0-phenocycler-penntmc-pipeline/launcher/run_datasink_uterus.sh --no_upload
set -e
...
echo "============================================================"
echo "Aegle Datasink - Uterus Cohort"
echo "============================================================"
...
echo ""
echo "[1/2] Collecting main pipeline reports (main_uterus_hb)..."
echo "------------------------------------------------------------"
python src/datasink.py \
    --stage main \
    --exp_set main_uterus_hb \
    --out_root "${OUT_ROOT}" \
    --remote "${REMOTE}" \
...
echo ""
echo "[2/2] Collecting analysis pipeline reports (analysis_uterus_hb)..."
echo "------------------------------------------------------------"
python src/datasink.py \
    --stage analysis \
    --exp_set analysis_uterus_hb \
    --out_root "${OUT_ROOT}" \
    --remote "${REMOTE}" \
    --remote_path "${REMOTE_PATH}" \
    ${UPLOAD} \
...
echo ""
echo "============================================================"
echo "Datasink completed for Uterus cohort!"
echo "============================================================"
