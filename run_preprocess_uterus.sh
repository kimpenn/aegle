#!/bin/bash
# nohup bash /workspaces/codex-analysis/0-phenocycler-penntmc-pipeline/run_preprocess_uterus.sh > logs/run_preprocess_uterus_$(date +%Y%m%d_%H%M%S).log 2>&1 &
...
EXP_SET_NAME="preprocess/preprocess_uterus_hb"
